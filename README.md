...
[![Build Status](https://travis-ci.org/iamnikolie/ramsql.svg)](https://travis-ci.org/iamnikolie/ramsql)
...
```
  go get github.com/iamnikolie/ramsql
```
...
```console
$ go install github.com/iamnikolie/ramsql
$ ramsql < schema.sql
